...
import omsu.imit.moviefinder.details.MovieDetailsActivity;
import omsu.imit.moviefinder.details.MovieDetailsFragment;
...
public class MoviesListingActivity extends AppCompatActivity implements MoviesListingFragment.Callback {
    ...
    private void setToolbar() {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle(R.string.movie_finder);
